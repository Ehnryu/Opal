...
from monochrome.errors import monochromeSyntaxError as LexerError
from monochrome.ttt import iteritems
        ...
        while pos < len(line):
            ...
            if matches is not None:
                ...
                if name not in self.ignore_tokens:
                    ...
                    elif name == 'NAME' and value in self.keywords or value in self.keywords:
    ...
    def tokenize(self, s):
        ...
        for line_num, line in enumerate(s.splitlines(), 1):
            ...
            if indent_symbol is not None:
                ...
                indent_level = self.count_indent(line)
...
class TokenStream(object):
    ...
    def is_end(self):
            return self._pos == len(self._tokens) or self._pos > len(self._tokens)
